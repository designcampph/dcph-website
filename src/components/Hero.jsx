...
export const Hero = () => {
  ...
  return (
    <div className='flex mx-24 mt-4 md:flex-col sm:flex-col'>
        <script type='text/javascript' src='//pl23868690.highrevenuenetwork.com/9a/81/fc/9a81fc3550955c7ba63ddd2c9981dc50.js'></script>
        ...
        <div className='h-full w-[40%] md:w-[100%] sm:w-[100%] mb-10'>
            ...
            <SignedOut>
              <SignInButton forceRedirectUrl={'/home'}>
                <button className='ml-[2%] mt-[5%] w-64 h-12 rounded-full font-bold text-zinc-900 bg-orange-400 drop-shadow-lg hover:bg-blue-400 sm:ml-0'>Sign in now!</button>
              </SignInButton>
            </SignedOut>
            <SignedIn>
