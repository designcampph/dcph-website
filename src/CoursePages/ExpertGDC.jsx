  ...
  return (
    <div className='bg-black w-screen h-screen'>
      ...
      { status===false ? <div className='mx-[10%] p-2 w-[80%] text-center border-violet-500 border-2'>
        ...
        <input type='password' value={pw} className='w-[80%] h-16 p-4 border-2 text-2xl mt-4 border-violet-500 bg-white' placeholder='Type the Password here...' onChange={e=> setPw(e.target.value)}></input><br/>
